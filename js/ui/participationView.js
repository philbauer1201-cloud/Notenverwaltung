      ...
      <td>
        <div class="flex items-center gap-2">
          ${student.photo
            ...
            : `<div class="student-avatar" style="width:28px;height:28px;font-size:.7rem;display:flex;align-items:center;justify-content:center;background:var(--bg-card-3);border:1px solid var(--border);border-radius:50%;font-weight:700;">${initials}</div>`
          }
